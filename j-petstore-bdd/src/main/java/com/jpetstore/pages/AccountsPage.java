...
public class AccountsPage extends BasePage {
	...
	private static final String FIRST_NAME_INPUT = "//*[@id='Catalog']//input[@name='firstName']";

	private static final String LAST_NAME_INPUT = "//*[@id='Catalog']//input[@name='lastName']";

	private static final String EMAIL_INPUT = "//*[@id='Catalog']//input[@name='email']";

	private static final String PHONE_INPUT = "//*[@id='Catalog']//input[@name='phone']";

	private static final String ADDR1_INPUT = "//*[@id='Catalog']//input[@name='address1']";

	private static final String ADDR2_INPUT = "//*[@id='Catalog']//input[@name='address2']";

	private static final String CITY_INPUT = "//*[@id='Catalog']//input[@name='city']";

	private static final String STATE_INPUT = "//*[@id='Catalog']//input[@name='state']";

	private static final String ZIP_INPUT = "//*[@id='Catalog']//input[@name='zip']";

	private static final String COUNTRY_INPUT = "//*[@id='Catalog']//input[@name='country']";

	private static final String LANGUAGE_PREFERENCE_DROPDOWN = "//*[@id='Catalog']//select[@name='languagePreference']";

	private static final String FAVOURITE_CATEGORY_DROPDOWN = "//*[@id='Catalog']//select[@name='favouriteCategoryId']";

	private static final String ENABLE_MY_LIST_CHECKBOX = "//*[@id='Catalog']//input[@name='listOption']";

	private static final String ENABLE_BANNER_CHECKBOX = "//*[@id='Catalog']//input[@name='bannerOption']";
